<?php
$connection = require_once ('note/Connection.php');
...
<h1>My Notes</h1>
<div class=".note-grid">
    <button id="toggleNoteForm()" class="add-note" >+ New Note</button>
    ...
    <div id="noteForm" class="note-form hidden">
        ...
        <?php endif; ?>
    <form id="note-form" class="new-note" action="note/createNote.php" method="post">
    ...
    <div class="notes">
        ...
        <?php foreach($notes as $note): ?>
            <div class="note">
                ...
                <form action="note/deleteNote.php" method="post">
